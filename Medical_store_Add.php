...
<form name="Medical_store_Add.php" action="Medical_store_Action.php" enctype="multipart/form-data" method="post" onSubmit="return validate()">
<body>
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header">Medical_store Details</h3>
</div>
</div>
</div>
</div>
   <div class="col-md-3">
     <div class="form-group">
        <label for="exampleInputEmail1" style="color:#000066"><b>Store Name</b></label>
          <td><input type="text" name="txt_store_name"  class="form-control" id="txt_store_name" value=""></td>
</div>
</div>
   <div class="col-md-3">
     <div class="form-group">
