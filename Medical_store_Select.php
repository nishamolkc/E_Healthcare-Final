...
return false;
      ...
      $db=new dbconnect();
      $varsql="Select medical_store.*, district.district_name,city.city_name from medical_store,district,city where medical_store.district_id=district.id and medical_store.city_id=city.id ";
    ...
    if($userlevel==1)
	  ...
	  if($row['status']==0)
	  {
	  	?>              
                         ...
                         <td align="center"><a class="glyphicon glyphicon-trash" href="Medical_store_Delete.php?mvarid=<?php echo $row[0]; ?>" onClick="return DeleteChecked(); "title="Delete"></a></td>
						 <td align="center"><a href="approve_medical_store.php?mvarid=<?php echo $row[0]; ?>">Approve</a></td>
 <?php
	  }
	  elseif($row['status']==1)
	  {
