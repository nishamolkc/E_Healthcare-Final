  ...
  <?php
      ...
      $db=new dbconnect();
          $var_id=$_GET['mvarid'];
      $varsql="select * from specialization where id='$var_id'";
  ...
  <?php
    if(isset($_POST['CmdSave']))
      {
          $var_id=$_POST['txt_id'];
          $var_specialization_name=$_POST['txt_specialization_name'];
      $vareditsql="Update specialization  Set specialization_name='$var_specialization_name' where id='$var_id'";
      $varupdate=mysql_query($vareditsql)or die(mysql_error());
      echo '<script>window.location = "Specialization_Select.php?pp=1";</script>';
      }
      ?>
<html>
<head>
...
<form name="Specialization_Edit.php" action="" method="post" onSubmit="return validate()">
<body>
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header" style="color:#000066"> Modify Specialization Details</h3>
</div>
</div>
   ...
   <div class="col-md-3">
     <div class="form-group">
        <label for="exampleInputEmail1" style="color:#000066"><b>Specialization Name</b></label>
          <td><input type="text" name="txt_specialization_name"  class="form-control" id="txt_specialization_name" value="<?php echo $tbrow['specialization_name']; ?>"></td>
</div>
</div>
   <div class="col-md-3">
