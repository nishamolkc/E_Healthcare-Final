...
$db=new dbconnect();
$var3="insert into qualification_details(doctor_id,qualification_id,college,university,year,certificate_path)values('$var_doctor_id','$var_quali_id','$var_college','$var_uni','$var_year','$var_certificate_path')";
