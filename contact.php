			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item--current" id="moble_nav_item_6"> <a href="contact.php" class="menu__link"> Contact </a> </li>
...
<!-- //banner1 -->
	<div class="banner-bottom" id="about">
		<div class="container">
		    ...
		    <p class="sub_t_agileits"><b>Get in touch...</b></p>
               ...
               <div class="col-md-4 contact-grid ">
					<div class="contact-grid1 agileits-w3layouts">
						...
						<div class="con-w3l-info">
						   <h4>Address </h4>
						  <p>Kottiyoor,<span>Kannur</span></p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
				...
				<div class="col-md-4 contact-grid">
					<div class="contact-grid3 w3l">
						...
						<div class="con-w3l-info">
						  <h4>Email</h4>
						  <p><a href="mailto:info@example.com">nishamolkc555@gmail.com</a>
