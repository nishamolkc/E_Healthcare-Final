...
<form name="Identity_card_Add.php" action="Identity_card_Action.php" method="post" onSubmit="return validate()">
<body>
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header">Identity_card Details</h3>
</div>
</div>
</div>
</div>
   <div class="col-md-3">
     <div class="form-group">
        <label for="exampleInputEmail1" style="color:#000066"><b>Card Type</b></label>
          <td><input type="text" name="txt_card_type"  class="form-control" id="txt_card_type" value=""></td>
</div>
</div>
   <div class="col-md-3">
