  ...
  <?php
      ...
      $db=new dbconnect();
          $var_id=$_GET['mvarid'];
      $varsql="select * from medical_lab where id='$var_id'";
  ...
  <?php
    if(isset($_POST['CmdSave']))
      {
          $var_id=$_POST['txt_id'];
          $var_lab_name=$_POST['txt_lab_name'];
      ...
      $vareditsql="Update medical_lab  Set lab_name='$var_lab_name',phone_number='$var_phone_number',email='$var_email',website='$var_website',district_id='$var_district_id',city_id='$var_city_id',status='$var_status',image_path='$var_image_path' where id='$var_id'";
      $varupdate=mysql_query($vareditsql)or die(mysql_error());
      echo '<script>window.location = "Medical_lab_Select.php?pp=1";</script>';
      }
      ?>
<html>
<head>
...
return false;
 ...
 var  dvar8 = document.getElementById("txt_image_path");
if(dvar8.value=="")
{
...
<form name="Medical_lab_Edit.php" action="" method="post" onSubmit="return validate()">
<body>
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header" style="color:#000066"> Modify Medical_lab Details</h3>
</div>
</div>
   ...
   <div class="col-md-3">
     <div class="form-group">
        <label for="exampleInputEmail1" style="color:#000066"><b>Lab Name</b></label>
          <td><input type="text" name="txt_lab_name"  class="form-control" id="txt_lab_name" value="<?php echo $tbrow['lab_name']; ?>"></td>
</div>
</div>
   <div class="col-md-3">
     <div class="form-group">
